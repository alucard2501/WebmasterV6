...
(function ($) {
    ...
    $.cleditor = {
        ...
        defaultOptions: {
            ...
            controls:     // controls to add to the toolbar
                          ...
                          "rule image link unlink | cut copy paste pastetext | source", //print
    ...
    cleditor = function (area, options) {
        ...
        var $main = editor.$main = $(DIV_TAG)
            ...
            .css({ position: options.position, top: options.top, left: options.left });
...
(function($) {
    $.cleditor.buttons.imgSelector = {
        name: "imgSelector",
        image: "../../images/jquery_cleditor/btn_image.png",
        title: "插入图片",
        command: "inserthtml",
        popupName: "",
        popupClass: "",
        popupContent: "",
        buttonClick: imgClick
    };
    $.cleditor.dialogImageSelector = null;
    $.cleditor.defaultOptions.controls = $.cleditor.defaultOptions.controls
    .replace("bold", "hello bold");
 
    function imgClick(e, data) {
        if (data.editor.dialogImageSelector == null) {
            data.editor.dialogImageSelector = $(data.button).ImgSelector({
                IsMult: true,
                onSubmit: function (imgs, element) {         
                    data.editor.execCommand(data.command, imgs, null, data.button);
                }
            });
        }
        data.editor.dialogImageSelector.ImgSelector("openDialog");
    }
