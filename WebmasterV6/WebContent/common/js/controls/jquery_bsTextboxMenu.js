    ...
    $.widget("custom.TextboxMenu", {
        ...
        _create: function () {
                ...
                $.ajax({
                    ...
                    success: function (response, status, xhr) {
                        if (response.status == "SUCCESS") {
                            ...
                            $(".custom-TextboxMenu-liMenuRight1").mousedown(function(){
                            	$(".custom-TextboxMenu-liMenuRight1").removeClass("custom-TextboxMenu-liMenuRight2_down");
                            	$(this).addClass("custom-TextboxMenu-liMenuRight2_down");
                            }).mouseup(function(){
                            	$(".custom-TextboxMenu-liMenuRight1").removeClass("custom-TextboxMenu-liMenuRight2_down");
                            });
                        } else {
            ...
            this._dialog.getLiTextboxMenuDepartment=function(){
            	var data = {}, temp="";
                data.sessionid = request("SessionId");
                data.action = "NHSCHOOL_LOAD_DEPARTMENT";
                $.ajax({
                    type: "POST",
                    url: GET_DATA,
                    data: data,
            ...
            this._span.find(".btnTextboxAdvance").click(function () {
            	var temp=[];
            	if(_dialog.element.val().trim().length>0){
            		temp=_dialog.element.val().split(",");
            	}
            	_dialog._arr_select=temp;
        ...
        _createHtml: function () {
            ...
            this._span.find("#text2")[0].addEventListener('keydown',function(event){
